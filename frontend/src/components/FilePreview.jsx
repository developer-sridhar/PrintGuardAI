    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-full">
            ...
            <div className="flex-grow bg-slate-100 p-6 flex items-center justify-center relative group min-h-[400px]">
                ...
                <div className="relative w-full max-w-sm aspect-[1/1.414] bg-white shadow-lg border border-slate-200 rounded animate-fade-in mx-auto transform transition-transform group-hover:scale-[1.02]">
                    ...
                    <div className="absolute inset-4 border-2 border-dashed border-cyan-200/50 rounded flex flex-col items-center justify-center bg-cyan-50/20">
                        <span className="text-sm font-medium text-slate-400">Page 1 / 4</span>
                        <span className="text-xs text-slate-400 mt-2">A4 (210 x 297 mm)</span>
                    </div>
                </div>
            </div>
        </div>
